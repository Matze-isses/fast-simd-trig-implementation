...
double
cmeasure_total_us(struct cmeasure_t* aMeasure) {
  return (((double) cmeasure_total_ns(aMeasure)) / ((double) 1000.0));
}
...
double
cmeasure_total_m(struct cmeasure_t* aMeasure) {
  return (((double) cmeasure_total_s(aMeasure)) / ((double) 60.0));
}

double
cmeasure_total_h(struct cmeasure_t* aMeasure) {
  return (((double) cmeasure_total_m(aMeasure)) / ((double) 60.0));
}
...
double
cmeasure_div_us(struct cmeasure_t* aMeasure, const double lDivBy) {
  double lTotTime = (double) cmeasure_total_us(aMeasure);
  return (lTotTime / lDivBy);
}
