...
double  cmeasure_total_us(struct cmeasure_t* aMeasure);
double  cmeasure_total_ms(struct cmeasure_t* aMeasure);
double  cmeasure_total_s(struct cmeasure_t* aMeasure);
double  cmeasure_total_m(struct cmeasure_t* aMeasure);
double  cmeasure_total_h(struct cmeasure_t* aMeasure);
double  cmeasure_div_ms(struct cmeasure_t* aMeasure, const double lDivBy);
double  cmeasure_div_us(struct cmeasure_t* aMeasure, const double lDivBy);
