...
int main(void)
{
    ...
    double taylor_poly[13] = {
        0x1.555555555554cp-2,
        0x1.111111111110ep-3,
        0x1.ba1ba1ba1ba1cp-5,
        0x1.664f4882c10fdp-6,
        0x1.226e355e6c23bp-7,
        0x1.d6d3d0e157dep-9,
        0x1.7da36452b75e2p-10,
        0x1.3558248036745p-11,
        0x1.f57d7734d165ep-13,
        0x1.967e18afcafadp-14,
        0x1.497d8eea25255p-15,
        0x1.0b132d39a604ap-16,
        0x1.b0f72d3ee24ep-18,
    };

    const int range = 2; // {-1,0,+1}
